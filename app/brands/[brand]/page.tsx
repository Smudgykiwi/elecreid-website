...
const brandData: Record<string, BrandData> = {
  'apple-home': {
    ...
    features: [
      ...
      },
      {
        ...
        imageAlt: 'Smart home automation controller in a Melbourne residence',
      },
    ],
    whyPoints: [
      {
  ...
  'basalte': {
    ...
    metaDescription: "Authorised Basalte dealer in Melbourne. Elec Reid installs Basalte Sentido, Fibonacci, and Ellie touchscreens in Melbourne's finest residences. Belgian precision, locally installed.",
    h1: 'Basalte',
    ...
    introParagraphs: [
      "Basalte makes the finest switches and touchscreens in the world. Full stop. The Sentido, the Fibonacci, the Ellie touchscreen — each one is a considered object. Designed in Belgium. Specified by architects.",
      "Installed by Elec Reid in Melbourne homes where every surface is treated as a decision. If you are specifying marble benchtops and European hardware, you should not have plastic rocker switches on the wall.",
      "Basalte is not a workaround. It is the answer to the question: what if a switch were as well-designed as everything else in the room?",
    ],
    features: [
      {
        heading: 'Sentido and Fibonacci',
        subheading: 'Two switches. Infinite configurations.',
        body: "The Sentido reads your touch — a capacitive surface with no moving parts, available in brushed brass, matte black, and white. The Fibonacci pushes back with the weight of precision metal. Both are available in single, double, triple, and quad configurations. Both support KNX and Basalte Home natively. Both look like they belong in a gallery.",
        image: '/images/basalte-fibonacci.jpg',
        imageAlt: 'Basalte Fibonacci switches in a Melbourne architectural home',
      },
      {
        heading: 'Ellie touchscreen',
        subheading: 'One surface. Every room.',
        body: "The Ellie is a 5-inch touchscreen that replaces every switch in a room. Basalte Home, Apple Home, KNX — all controlled from one surface. Adjust lighting scenes. Control blinds. Set the thermostat. See who is at the front door. The Ellie does not look like a tablet stuck to a wall. It looks like it was designed specifically for that wall.",
    ...
    whyPoints: [
      {
        heading: "We are authorised Basalte dealers.",
        body: "We order direct. We hold stock. We know the spec sheets inside out and we have programmed Basalte systems across Melbourne projects of every scale.",
      },
      {
        heading: "Every installation is programmed and tested before we leave site.",
        body: "Scenes, automations, integrations — all verified. You walk in and it works. We do not leave you with a manual and a phone number.",
      },
      {
        heading: "We match finish to architecture.",
        body: "Brushed brass, matte black, white — specified with your designer, not after. Basalte comes in enough finishes to sit correctly in any interior.",
      },
    ],
    relatedBrands: [
  ...
  'home-assistant': {
    ...
    introHeading: 'The most powerful smart home platform on the planet.',
    introParagraphs: [
      "Home Assistant is open source, community-driven, and runs locally on hardware inside your home. No cloud. No subscription. No vendor lock-in.",
      "Every device. Every protocol. Every automation you can imagine. If a smart home device exists, Home Assistant can probably control it. If an automation is possible, Home Assistant can probably do it.",
      "We deploy Home Assistant on dedicated hardware — spec'd correctly, rack-mounted, backed up, and configured before we hand you the keys.",
    ],
    features: [
      {
        heading: 'Local first. Always.',
        subheading: 'No cloud dependency. No outage risk.',
        body: "Home Assistant runs on hardware in your home. When your internet goes down, your home keeps working. When the Home Assistant cloud servers are under maintenance, your automations still fire. When a vendor discontinues their cloud API — which happens — your system is not affected. Local processing is not a feature. It is the foundation.",
        image: '/images/haven-7.jpg',
        imageAlt: 'Network rack with Home Assistant hardware in a Melbourne residence',
      },
      {
        heading: 'Every device. Every protocol.',
        subheading: '2,000+ integrations built in.',
        body: "Z-Wave, Zigbee, Matter, Thread, Modbus, KNX, DALI. Home Assistant speaks them all. Legacy devices you bought ten years ago. New devices fresh from the manufacturer. Devices that were never designed to talk to each other. Home Assistant connects them. We configure them. You control them.",
    ...
    whyPoints: [
      {
        ...
        body: "Home Assistant on underpowered hardware is a disaster. We size the compute, storage, and UPS correctly for your system from day one.",
      },
      {
        heading: "We document every automation.",
        body: "A Home Assistant installation is only as good as its documentation. We write it up. Every entity, every automation, every integration — so you can understand what you own.",
      },
      {
        heading: "We train you to use it.",
        body: "Home Assistant has a learning curve. We flatten it. One hour of training at handover, and you understand how to add a device, build a simple automation, and read a dashboard.",
      },
    ],
    relatedBrands: [
      { label: 'Unifi', href: '/brands/unifi' },
  ...
  'control4': {
    ...
    metaDescription: "Authorised Control4 dealer in Melbourne. Elec Reid installs and programs Control4 smart home systems — touchscreens, keypads, full integration. Twenty years of proven reliability.",
    h1: 'Control4',
    ...
    features: [
      {
        heading: 'CA-10 and Core controllers',
        subheading: 'Right-sized for every project.',
        body: "The CA-10 runs a small apartment. The Core 3 runs an estate. Both are dealer-configured, warranty-backed, and remotely accessible by us for support. Control4 controllers are not smart home hubs you configure through an app — they are engineered automation engines that run your home reliably, day after day.",
        image: '/images/control4-x4.jpg',
        imageAlt: 'Control4 controller and touchscreen in a Melbourne smart home',
      },
      {
        heading: 'T4 touchscreens and Lux keypads',
        subheading: 'Purpose-built hardware.',
        body: "Wall-mounted glass touchscreens that show every room, every source, every scene. Lux keypads that blend into the wall with backlit buttons for the scenes you use most. Purpose-built hardware, not a tablet running an app. Control4 hardware is designed to be mounted in a wall and used for a decade without looking dated.",
  ...
  'knx': {
    ...
    introHeading: 'Not a brand. A protocol. The one that matters.',
    introParagraphs: [
      "KNX is the European standard for building automation. Manufacturer-independent, decentralised, and engineered to last decades. Lighting, blinds, HVAC, audio, security — all speaking a single language, regardless of who made the hardware.",
      "It is the infrastructure choice for homes built to endure. If you are building or renovating a home with a thirty-year horizon, KNX is the wiring decision you will not regret.",
      "We are certified KNX programming partners. ETS-trained. We design, supply, install, and commission KNX systems across Melbourne's prestige residential market.",
    ],
    features: [
      {
        heading: 'Decentralised by design',
        subheading: 'No single point of failure.',
        body: "KNX intelligence lives in each device on the bus — not in a central controller. If one device fails, the rest keep working. If the programming station is offline, your home keeps working. This is not a theoretical advantage. It is the reason architects specify KNX in buildings they expect to stand for fifty years.",
        image: '/images/ekinex-proxima.jpg',
        imageAlt: 'Ekinex Proxima KNX keypad in a Melbourne architectural home',
      },
      {
        heading: 'Ekinex and Basalte — native',
        subheading: 'The finest interfaces in the world.',
        body: "The finest KNX interfaces in the world are made in Europe. Ekinex 20Venti and Proxima keypads. Basalte Sentido and Fibonacci switches. Both run KNX natively — no bridge, no workaround, no middleware. Specified together, they create a home where every interaction feels considered.",
    ...
    whyPoints: [
      {
        heading: "We are certified KNX programming partners.",
        body: "KNX programming requires ETS software and formal training. We are certified. We have programmed KNX systems in Melbourne homes from single-room retrofits to whole-of-home new builds.",
      },
      {
  ...
  'unifi': {
    ...
    metaDescription: "Unifi network installation Melbourne. Elec Reid installs enterprise-grade Ubiquiti Unifi networking, cameras, and intercom systems in Melbourne smart homes. Zero dead zones.",
    h1: 'Unifi',
    tagline: 'Enterprise networking. For the home that demands it.',
    heroImage: '/images/haven-7.jpg',
    heroImageAlt: 'Unifi network rack installation in a Melbourne smart home',
    introHeading: 'Every smart home lives or dies on its network.',
    introParagraphs: [
      "Every smart home lives or dies on its network. Slow Wi-Fi is not a smart home problem — it is a network problem. Dead zones are not a smart home problem. Dropped automations, laggy camera feeds, lights that respond a second late — all of it is a network problem.",
      "Unifi by Ubiquiti is the enterprise-grade infrastructure we install in every serious residential project. Access points, switches, gateways, cameras, intercoms — a complete ecosystem designed to perform under load and be managed from a single dashboard.",
    ...
    features: [
      {
        heading: 'Access points that actually cover',
        subheading: 'U6 and U7 Pro. Zero dead zones.',
        body: "UniFi U6 and U7 Pro access points blanket a Melbourne home in signal. Ceiling-mounted, PoE-powered, centrally managed. We model coverage before installation. Every room, every outdoor zone, the garage — all in the plan. No extenders. No mesh compromise. Proper structured wireless, designed like infrastructure.",
        image: '/images/haven-7.jpg',
        imageAlt: 'Unifi networking rack and access point installation in Melbourne',
      },
      {
        heading: 'Protect and Access',
        subheading: 'Cameras and intercom — one platform.',
        body: "UniFi Protect records locally to a Network Video Recorder in your rack. No cloud subscription. No footage leaving your home. UniFi Access controls your front door, back gate, and garage — with video intercom, mobile unlock, and an access log. All managed from the same dashboard as your network.",
        image: '/images/travancore-1.jpg',
        imageAlt: 'Smart home networking and camera system in a Melbourne residence',
      },
    ],
    whyPoints: [
      {
        heading: "We design the network before we pull cable.",
